...
The final dataset includes 3320 word types in total, with 2024 in the English corpus and 1296 in the French corpus. On average, infants produced 8 tokens of each word type in a single session (SD = 18; mean English tokens = 6, SD = 11; mean French tokens = 13, SD = 29).
