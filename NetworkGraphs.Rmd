...
cap <- sprintf("Change in mean path length as network size increases, in Real vs. Simulated (random and small-world) data. Coloured lines represent Data type; coloured bands represent 95%% CIs.")
```
