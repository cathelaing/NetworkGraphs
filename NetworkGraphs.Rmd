...
As shown in Figure \@ref(fig:plotted-smooth-MPL)

```{r plotted-smooth-MPL, echo=FALSE, fig.cap=cap, fig.pos='H', message=FALSE, warning=FALSE,results='hide',fig.keep='all'}

path_length_plot
cap <- sprintf("Smooth plot showing mean path length of the nine infants' networks over time, in both Actual (red) and Target (blue) forms. Shaded areas show 95%% confidence intervals, lines indicate mean trajectories over time.")
```

This is consistent in the clustering coefficient data, shown in Figure \@ref(fig:plotted-smooth-CC)

```{r plotted-smooth-CC, echo=FALSE, fig.cap=cap, fig.pos='H', message=FALSE, warning=FALSE,results='hide',fig.keep='all'}

clust_coef_plot
cap <- sprintf("Smooth plot showing mean clustering coefficient of the nine infants' networks over time, in both Actual (red) and Target (blue) forms. Shaded areas show 95%% confidence intervals, lines indicate mean trajectories over time.")
```
