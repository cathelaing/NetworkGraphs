...
global_pathlength_A <- lmerTest::lmer(path_length ~ age + corpus + (1+age|Speaker),
                                             data=subset(SWD_red,
                                                           data_type == "actual")
                                                           ,
                                       REML=FALSE)
#summary(global_pathlength_A)

global_pathlength_A_null <- lmerTest::lmer(path_length ~ corpus + (1+age|Speaker),
                                             data=subset(SWD_red,
                                                           data_type == "actual")
                                                           ,
                                       REML=FALSE)

pathlength_A <- anova(global_pathlength_A, global_pathlength_A_null)
